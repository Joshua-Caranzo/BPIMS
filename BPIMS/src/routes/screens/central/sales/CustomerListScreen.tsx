...
type Props = NativeStackScreenProps<CentralSalesParamList, 'CustomerList'>;
...
const CustomerListScreen = React.memo(({ route }: Props) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <TitleHeaderComponent isParent={false} title="Customers" onPress={() => navigation.goBack()} userName={user.name}></TitleHeaderComponent>
